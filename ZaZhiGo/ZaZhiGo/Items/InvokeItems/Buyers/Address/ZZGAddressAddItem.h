...
@interface ZZGAddressAddItem : ZZGHttpBaseItem
@property (nonatomic, strong) NSString *true_name;     // 姓名
@property (nonatomic, strong) NSString *city_id;     // 城市编号(地址联动的第二级)
@property (nonatomic, strong) NSString *area_id;     // 地区编号(地址联动的第三级)
